    ...
    <div className="lg:w-[90%] mx-auto">
        ...
        <div className="flex justify-between items-center lg:gap-4 gap-5">
          ...
          <div>
            ...
            >
              ...
              <Image
                src={AllImages.contest.leaderboard.myTeam.InviteIcon}
      ...
      <div className="lg:flex justify-start ">
        <div className=" lg:w-[70%] ">
          {/* Scores */}
          <div className="my-5 grid grid-cols-2 justify-items-center lg:flex items-center gap-10">
            <Image
            ...
            <div>
              <div className="flex items-center gap-2 ">
                ...
                <SiGoogletranslate className="lg:h-7 h-5 w-fit -mt-2 text-site-color" />
              </div>
          ...
          <div className="relative overflow-y-scroll bg-[#181818] py-6 px-5 lg:h-[65vh] flex flex-col gap-8 rounded-md">
            <div className="flex justify-between">
              ...
              <div>
                ...
                >
                  <span className="uppercase text-sm">Master</span>
                </Button>
              </div>
              <div>
                <Button
