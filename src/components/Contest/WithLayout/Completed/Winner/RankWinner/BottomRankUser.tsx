      ...
      <div className="my-10">
        ...
        >
          <div className="absolute top-0 left-0 p-3">
            <h1 className="font-semibold text-2xl">#543</h1>
          </div>
          {/* Div on top-right */}
          ...
          {/* Div in the middle */}
          <div className="flex flex-col justify-center items-center lg:mx-10 lg:py-24 lg:h-96"></div>
        ...
        <div className=" my-5 mx-16 grid grid-cols-2  lg:grid-cols-3 items-center justify-items-center justify-center gap-4">
          <Image
